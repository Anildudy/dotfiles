        ...
        MenuBar {
            ...
            Menu {
                ...
                AppMenuItem { 
                    text: qsTr("Network");
                    onClicked: { 
                        Quickshell.execDetached(["kitty", "--class", "dotfiles-floating", "-e", Quickshell.env("HOME") + "/.config/dotfiles-settings/scripts/dot-network"])
                    }
                }    
                AppMenuItem { 
                    text: qsTr("Bluetooth");
                ...
                AppMenuItem { 
                    ...
                    onClicked: {
                        Quickshell.execDetached(["qs", "-p", Quickshell.env("HOME") + "/.local/share/dotfiles-settings-app/quickshell", "ipc", "call", "settings", "toggle"])
                    }
                }
                AppMenuItem { 
                    ...
                    onClicked: { 
                        if (root.isHyprlandSettingsInstalled) {
                            ...
                            Quickshell.execDetached(["kitty", "--class", "dotfiles-floating", "-e", Quickshell.env("HOME") + "/.config/dotfiles-settings/scripts/dot-install-hyprlandsettings"])
                        }
                    }
                }
                background: Rectangle {
            ...
            Menu {
                ...
                AppMenuItem { 
                    ...
                    onClicked: { 
                        Quickshell.execDetached(["kitty", "--class", "dotfiles-floating", "-e", Quickshell.env("HOME") + "/.config/dotfiles-settings/scripts/dot-install-sddm"]) 
                    }
                }
                AppMenuItem { 
                    text: qsTr("Network Manager Applet");
                    onClicked: { 
                        Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/dotfiles-settings/scripts/dot-toggle-nmapplet"])
                    }
                }
                AppMenuItem { 
                    text: qsTr("Change Shell");
                    onClicked: { 
                        Quickshell.execDetached(["kitty", "--class", "dotfiles-floating", "-e", Quickshell.env("HOME") + "/.config/dotfiles-settings/scripts/dot-change-shell"])
                    }
                }
                AppMenuItem { 
            ...
            Menu {
                ...
                AppMenuItem { text: qsTr("App OS Homepage"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://dotfiles.local/os/"])
                    }
                }
                AppMenuItem { text: qsTr("App OS GitHub"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://github.com/mylinuxforwork/dotfiles"]) 
                    } 
                }
                AppMenuItem { text: qsTr("App OS Changelog"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://github.com/mylinuxforwork/dotfiles/blob/main/CHANGELOG.md"]) 
                    } 
                }
                AppMenuItem { text: qsTr("App YouTube Channel"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://www.youtube.com/channel/UC0sUzmZ0CHvVCVrpRfGKZfw"]) 
                    } 
                }
                AppMenuItem { text: qsTr("Get more Wallpapers"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://github.com/mylinuxforwork/wallpaper"]) 
                    } 
                }
                AppMenuSeparator {}
                AppMenuItem { text: qsTr("Hyprland Homepage"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://github.com/mylinuxforwork/wallpaper"]) 
                    } 
                }
                AppMenuItem { text: qsTr("Hyprland Wiki"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://github.com/mylinuxforwork/wallpaper"]) 
                    } 
                }
                AppMenuItem { text: qsTr("Update App OS"); onClicked: { 
                    Quickshell.execDetached(["xdg-open", "https://dotfiles.local/os/getting-started/update"]) 
                    } 
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Button {
                            ...
                            onClicked: {
                                Quickshell.execDetached(["flatpak", "run", "com.dotfiles.hyprlandsettings"])
                            }
                            background: Rectangle {
                                color: "transparent"
                                radius: 10
