...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="$HOME/.config/dotfiles-settings/listeners/gtk-theme-switcher.sh"
LISTENERS["low-bat-notification"]="$HOME/.config/dotfiles-settings/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/dotfiles-settings/listeners/another-listener.sh"
